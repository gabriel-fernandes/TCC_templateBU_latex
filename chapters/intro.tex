...
A Tabela~\ref{tab:a_table_formatacao_de_texto}  \cite{ols_intro_econometrics} \cite{reg_analysis_weighted} mostra  informações do modelo de teses da Biblioteca Universitária da UFSC (BU-UFSC).
